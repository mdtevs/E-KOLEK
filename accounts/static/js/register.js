  ...
  .then(data => {
    if (data.success) {
      ...
      if (emailVerified) {
        ...
        submitBtn.textContent = originalText || 'Register Family';
      }
...
if (signupForm) {
  ...
  signupForm.addEventListener('submit', function(e) {
    ...
    if (otpVerified !== 'true') {
      e.preventDefault();
      showMessage('Please verify your phone number before registering.', 'error');
    ...
    if (emailVerified !== 'true') {
      e.preventDefault();
      showMessage('Please verify your email address before registering.', 'error');
